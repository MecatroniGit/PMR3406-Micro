...
# 18 "/opt/microchip/mplabx/v5.40/packs/Microchip/PIC16Fxxx_DFP/1.2.33/xc8/pic/include/xc.h"
...
# 52 "/opt/microchip/mplabx/v5.40/packs/Microchip/PIC16Fxxx_DFP/1.2.33/xc8/pic/include/proc/pic16f886.h"
...
# 30 "/opt/microchip/mplabx/v5.40/packs/Microchip/PIC16Fxxx_DFP/1.2.33/xc8/pic/include/pic.h"
...
# 114 "/opt/microchip/mplabx/v5.40/packs/Microchip/PIC16Fxxx_DFP/1.2.33/xc8/pic/include/eeprom_routines.h"
extern void eeprom_write(unsigned char addr, unsigned char value);
extern unsigned char eeprom_read(unsigned char addr);


# 91 "/opt/microchip/mplabx/v5.40/packs/Microchip/PIC16Fxxx_DFP/1.2.33/xc8/pic/include/pic.h"
...
# 4 "/opt/microchip/mplabx/v5.40/packs/Microchip/PIC16Fxxx_DFP/1.2.33/xc8/pic/include/__size_t.h"
...
# 41 "main.c"
asm("\tpsect eeprom_data,class=EEDATA,delta=2,space=3,noexec"); asm("\tdb\t" "0" "," "1" "," "-1" "," "0" "," "-1" "," "0" "," "0" "," "1");
asm("\tpsect eeprom_data,class=EEDATA,delta=2,space=3,noexec"); asm("\tdb\t" "1" "," "0" "," "0" "," "-1" "," "0" "," "-1" "," "1" "," "0");
...
for (int i = 0; i < 4; i++) {
for (int j = 0; j < 4; j++) {
matrizTransicaoEstados[i][j] = (signed char)( EEADR = contador, EECON1 &= 0x3F, EECON1bits.RD = 1, EEDATA);
contador ++;
}
}
}
